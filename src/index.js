...
const card = [
    ...
    { type: 'skills', title: "Skills", infoFirst: "React", ratingFirst: <Rating value = {3}/>, explanationFirst: "React course", infoSecond: "C", ratingSecond: <Rating value = {5}/>, explanationSecond: "C-course", infoThird: "Cisco Networks", ratingThird: <Rating value = {5}/>, explanationThird: "CCNA-course", infoFourth: "Development", ratingFourth: <Rating value = {5}/>, explanationFourth: "14 years of experiense"},
